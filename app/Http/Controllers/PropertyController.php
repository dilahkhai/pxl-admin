...
class PropertyController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'periode_sewa' => 'nullable|required_if:penggunaan,Disewakan|in:1 tahun,6 bulan,3 bulan,bulanan',
            'status_pbb' => 'required|in:sudah bayar,belum bayar',
            'harga_penawaran' => 'required|numeric|min:0',
            'deposit_sewa' => 'required|numeric|min:0',
            'harga_jual' => 'nullable|numeric|required_if:penggunaan,Dijual|min:0',
